...
@section('titulo', 'Visualizar Usuario')
@section('conteudo')

    <div class="card border-light">
        <div class="card-body">
            <section id="titulo">
                <h1 class="text-center pt-4">Visualizar Dados</h1>
            </section>
        </div>
    </div>
    <div class="container">
        ...
        {{ csrf_field() }}
            ...
            <div class="form-group row mt-5 mb-5">
                ...
                <div class="col-lg-6 input-group mb-2">
                    <input type="text" class="form-control" id="id_nome" tabindex="1" name="nome" value="{{$registro->nome}}" disabled>
                </div>
            </div>
            ...
            <div class="form-group row mt-5 mb-5">
                ...
                <div class="col-lg-6 input-group mb-2">
                    <input type="number" class="form-control" id="id_telefone" tabindex="2" name="telefone" placeholder="Digite sem traços" value="{{$registro->telefone}}" disabled>
                </div>
            </div>
            ...
            <div class="form-group row mt-5 mb-5">
                ...
                <div class="col-lg-6 input-group mb-2">
                    <input type="date" class="form-control sem_numero" id="id_data_visita" tabindex="3" name="datavisita" value="{{$registro->datavisita}}" disabled>
                </div>
            </div>
            ...
            <div class="form-group row mt-5 mb-5">
                ...
                <div class="col-lg-6">
                    <select  name="demanda" class="form-control" id="id_tipo_demanda" tabindex="4" value="{{$registro->demanda}}" disabled>
            ...
            <div class="form-group row mt-5 mb-5">
                ...
                <div class="col-lg-6">
                    <select  name="cidade" class="form-control" id="id_regiao_adm" tabindex="5" value="{{$registro->cidade}}" disabled>
            ...
            <div class="form-group row mt-5 mb-5">
                ...
                <div class="col-lg-6 input-group mb-2">
                    <input type="text" class="form-control" id="id_sei" tabindex="6" name="sei" value="{{$registro->sei}}" disabled>
                </div>
            </div>
            ...
            <div class="form-group row mt-5 mb-5">
                ...
                <div class="col-lg-6 input-group mb-2">
                    <input type="date" class="form-control" id="id_data_conclusao" tabindex="7" name="dataconclusao" value="{{$registro->dataconclusao}}" disabled>
                </div>
            </div>
            ...
            <div class="form-group row mt-5 mb-5">
                ...
                <div class="col-lg-6 input-group mb-2">
                    <input type="text" class="form-control" id="id_andamento" tabindex="8" name="andamento" value="{{$registro->andamento}}" disabled>
                </div>
            </div>
            ...
            <div class="form-group row mt-5 mb-5">
                ...
                <div class="col-lg-6 input-group mb-2">
                    <textarea class="form-control" name="observacoes" id="observacao" aria-label="With textarea" tabindex="9" disabled>{{$registro->observacoes}}</textarea>
                </div>
            </div>
